...
const ChangeAdminModal = ({ isOpen, onClose, caseId, currentAdminWallet }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-white rounded-lg w-full max-w-md p-6 shadow-xl min-h-[18rem] flex flex-col justify-between">
                <div>
                ...
                <div className="flex justify-between">
                    <button
                        ...
                        disabled={isPending}
                        className="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 min min-w-20"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 transition min-w-20 flex justify-center"
                    >
                        {isPending ? <SpinnerLoader2 /> : "Migrate"}
                    </button>
                </div>
            </div>
        </div>
