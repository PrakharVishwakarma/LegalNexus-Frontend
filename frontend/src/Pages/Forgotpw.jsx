        ...
        <div className=' bg-slate-200 w-4/12 h-52 rounded-md p-4 shadow-xl shadow-blue-200'>
            <p className='w-full text-center text-2xl'>Forget Password</p>
                ...
                <form onSubmit={handleForgotPassword} className='h-28 flex flex-col items-center justify-around mt-3'>
                    ...
                    <button type="submit" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Get Code</button>
